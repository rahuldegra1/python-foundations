...
#read in all the data from periodic table .csv

elementsFile = open('SMALL PYTHON PROJECTS/periodictable.csv', encoding = 'utf-8')
...
# to justify the text, we need to find the longest strig in all columns
...
# put all the elements data structure into a data structure

ELEMENTS = {} # the data structure that holds all the elements data
...
for line in elements:
    ...
    ELEMENTS[line[0]] = element #mao the atomic number to the element.
